...
<%@ include file="/WEB-INF/views/admin/common/include/required-include.jsp" %>
...
<body>
  <div id="container" class="effect mainnav-lg">
    ...
    <%-- 헤더 시작 --%>
    <!--===================================================-->
    <jsp:include page="/WEB-INF/views/admin/common/include/header.jsp" />
    <!--===================================================-->
    <%-- 헤더 종료 --%>
    ...
    <div class="boxed">
      ...
      <%-- 레프트 사이드 메뉴 --%>
      <jsp:include page="/WEB-INF/views/admin/common/include/sidebar.jsp" />
      
      <%-- 라이트 사이드 메뉴 --%>
      <jsp:include page="/WEB-INF/views/admin/common/include/asidebar.jsp" />

    </div>

    <%-- 푸터 --%>
    <jsp:include page="/WEB-INF/views/admin/common/include/footer.jsp" />
  ...
  <!--jQuery [ REQUIRED ]-->
  <script src="${currentThemePath}/js/jquery-2.1.1.min.js"></script>
