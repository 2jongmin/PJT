...
public class RestMemberController {
  ...
  public ResponseEntity<String> verifySocialLoginAccessToken(HttpServletRequest request) throws Exception {
    ...
    LoginTypeCodeEnum socialTypeCode = LoginTypeCodeEnum.getEnumByValue(socialTypeCodeStr);
    
    String userId = null;
    
    if(socialTypeCode == LoginTypeCodeEnum.API_FACEBOOK_CODE || socialTypeCode == LoginTypeCodeEnum.API_GOOGLE_CODE) {
